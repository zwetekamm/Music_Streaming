<?php
	...
	if (isset($_GET['term'])) {
		// decode will convert characters--such as spaces--to correct char
...
<script>
	// Set focus on inputs search upon page load
	$(".searchInput").focus();
	// Timer function that searches after 2 seconds of keyup time
	$(function() {
		$(".searchInput").keyup(function() {
			// Clears timer when typing begins
			clearTimeout(timer);

			timer = setTimeout(function() {
				// Opens page with new val (search term) appended to url
...
<div class="tracklistContainer borderBottom">
	...
	<ul class="tracklist">
		...
		<?php
		// % returns any characters after term
		...
		$i = 1;
		/* Loop all rows returned by query */
...
<div class="artistContainer borderBottom">
	...
	<?php 
		$artistsQuery = mysqli_query($con, "SELECT id FROM artists WHERE name LIKE '$term%' LIMIT 5");
